                    ...
                    .then(result => {
                        ...
                        user.save()
                            .then(user => {
                                ...
                                const from = "do-not-reply@buildgreatness.com"
                                const to = user.email
                                const subject = "Build Greatness - Password Change Confirmation"
    ...
    (req, res, next) => {
        ...
        User.findOne({email: req.body.email})
            .then(user => {
                ...
                const subject = "Build Greatness - Password Reset Request"
                ...
                jwt.verify(req.body.token, user.password, error => {
                    ...
                    user.save()
                        .then(() => {
                            ...
                            const from = "do-not-reply@buildgreatness.com"
                            const to = user.email
                            const subject = "Build Greatness - Password Reset Confirmation"
